...
- orquestrar backend e frontend no Docker Compose;
- adicionar monitoramento e logs estruturados;
- ampliar cobertura de testes nos fluxos de relatórios e exportação;
- melhorar observabilidade de erros no frontend;
- incluir publicação automatizada de migrations em ambiente de homologação.
